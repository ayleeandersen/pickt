...
.card-img{width:100%;flex:1;min-height:0;object-fit:contain;background:#000;flex-shrink:1;border-bottom:1px solid ${T.border};}
.card-body{display:flex;flex-direction:column;align-items:center;gap:10px;padding:24px 20px 40px;text-align:center;width:100%;flex-shrink:0;min-height:0;justify-content:center;}
.card-body::-webkit-scrollbar{display:none;}
.card-emoji{font-size:52px;line-height:1;margin-bottom:12px;}
.card-name{font-family:'Syne',sans-serif;font-size:22px;font-weight:800;line-height:1.2;width:100%;word-wrap:break-word;overflow-wrap:break-word;margin-bottom:2px;}
